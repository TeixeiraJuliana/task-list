...
class ThemesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create theme" do
    assert_difference("Theme.count") do
      post themes_url, params: { theme: { status_theme: @theme.status_theme, title_list: @theme.title_list, type_list: @theme.type_list } }
    end
  ...
  test "should update theme" do
    patch theme_url(@theme), params: { theme: { status_theme: @theme.status_theme, title_list: @theme.title_list, type_list: @theme.type_list } }
